...
<body>
        ...
        function statusChangeCallback(response) {
            ...
            if (response.status === 'connected') {
                ...
                AWS.config.credentials = new AWS.CognitoIdentityCredentials({
                    IdentityPoolId: 'eu-west-1:e13fda06-6636-4c14-af23-c16b346ed4a6',
                    regions: 'eu-west-1',
                    Logins: {
                ...
                AWS.config.credentials.get(function () {
                    ...
                    syncClient.openOrCreateDataset('myDataset', function (err, dataset) {
                        dataset.put('loginname', 'lhueper', function (err, record) {
                            dataset.synchronize({
                                onSuccess: function (data, newRecords) {
                                    console.log('Facebook identity posted.');
                                },
    ...
    <input id="cgvalue" name="cgvalue" type="text"><br>
    <button onclick="putDataInDataset(getElementById('cgvalue').value)">PUSH DATA</button>
</body>
</html>
